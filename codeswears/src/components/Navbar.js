...
function Navbar() {
  ...
  return (
    <div className='flex flex-col md:flex-row md:justify-start items-center justify-center py-4' >
      ...
      <div ref={ref} className="sidebar absolute w-72 px-8 py-10 top-0 h-full right-0 bg-pink-100 p-10 transform transition-transform translate-x-full">
        ...
        <div className="flex">
          ...
          <button class="flex mx-auto text-white bg-pink-500 border-0 py-2 px-4 focus:outline-none hover:bg-pink-600 rounded text-lg">Clear Cart</button>
        </div>
      </div>
    </div>
  )
