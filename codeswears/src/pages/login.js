            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <Link href={"#"} class="text-sm font-medium text-primary-600 hover:underline ">Forgot password?</Link>
                </div>
                ...
                <p class="text-sm font-light text-gray-500 ">
                  Don’t have an account yet? <Link href={"/signup"} class="font-medium text-primary-600 hover:underline">Sign up</Link>
                </p>
              </form>
            </div>
          </div>
