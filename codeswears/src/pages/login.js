            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form class="space-y-4 md:space-y-6" action="#">
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-start">
                    <div class="flex items-center h-5">
                      <input id="remember" aria-describedby="remember" type="checkbox" class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-pink-300 " required="" />
                    </div>
                    <div class="ml-3 text-sm">
                      <label for="remember" class="text-gray-500">Remember me</label>
                    </div>
                  </div>
                  <Link href={"/forgot-password"} class="text-sm font-medium text-pink-600 hover:underline ">Forgot password?</Link>
                </div>
                ...
                <p class="text-sm font-light text-gray-500 ">
                  Don’t have an account yet? <Link href={"/signup"} class="font-medium text-pink-600 hover:underline">Sign up</Link>
                </p>
              </form>
            </div>
          </div>
