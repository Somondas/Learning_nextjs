        ...
        <section className="text-gray-600 body-font overflow-hidden">
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-top rounded" src="https://m.media-amazon.com/images/I/61jRA07VmuL._UX679_.jpg" />
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => addToCart(slug, 1, 499, "M", "Black", "The Catcher in the Rye")} className="flex ml-4 text-white bg-pink-500 border-0 px-3 py-1 md:py-2 md:px-6 focus:outline-none hover:bg-pink-600 rounded">Add To Cart</button>
